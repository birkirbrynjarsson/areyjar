This is a edited clone of Start Bootstrap - Grayscale
Deleted gulp tasks npm dependencies and made it into a very simple static site which as many cdn references to dependencies as possible.
Simple web is nice.
